...
const Pagination: React.FC<PaginationProps> = ({ currentPage, pageHandler }) => {
  ...
  return (
    <div className={classes.root}>
      <svg onClick={previousPageHandler} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
        <title />
        <g data-name="1" id="_1">
      ...
      <svg onClick={nextPageHandler} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
        <title />
        <g data-name="1" id="_1">
